...
class Ride(models.Model):
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(fields=['id', 'car'], name='ride_primary_key') # Composite Key
        ]
...
class Booking(models.Model):
    ...
    class Meta:
        constraints = [
            models.UniqueConstraint(fields=['ride', 'user'], name='booking_primary_key') # Composite Key
        ]
